...
```{r plot_historic_fao_gmia, cache=TRUE, dependson="historic_fao_gmia", fig.height=4.3, fig.width=5.4}
...
```{r plot_future_irrigation, cache=TRUE, dependson="future_irrigation", fig.height=7, fig.width=5.7}
...
```{r plot_all_australia, cache=TRUE, dependson=c("australian_regressions", "plot_australian"), fig.height=4.5, fig.width=5.6}
...
```{r australian_diagnostics, cache=TRUE, dependson="australian_regressions", fig.height=5, fig.width=3.5}
...
```{r plot_beta, cache=TRUE, dependson="boot_beta", fig.height=2.5}
